...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="dateNaissance" name="dateNaissance" type="date" placeholder="Date de naissance" class="form-control input-md" required="">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="numsecu">Numéro sécu</label>  
  <div class="col-md-4">
  <input id="numsecu" name="numsecu" type="text" placeholder="Numéro sécu" class="form-control input-md" required="">
